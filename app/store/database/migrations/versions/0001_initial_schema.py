...
game_status_enum = postgresql.ENUM("PENDING", "ACTIVE", "FINISHED", name="gamestatus", create_type=False)
deal_type_enum = postgresql.ENUM("BUY", "SELL", name="dealtype", create_type=False)
phrase_type_enum = postgresql.ENUM("GROWTH", "STABLE", "FALL", name="phrasetype", create_type=False)
