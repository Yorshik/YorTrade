...
def build_initial_runtime_state(game_id: int, chat_id: int, platform: str = "TG") -> RuntimeState:
    return {
        "game_id": game_id,
        "chat_id": chat_id,
...
async def init_runtime_state(app, game_id: int, chat_id: int, platform: str = "TG") -> RuntimeState:
    ...
    state = build_initial_runtime_state(game_id=game_id, chat_id=chat_id, platform=platform)
    await save_runtime_state(app, state)
    return state
